...
<div class="card">
  ...
  <div class="card-body">
      ...
      <table class="table table-striped">
        <tr>
          <th>ID</th><th>Cat�gorie</th><th>Date Cr�ation</th><th>Suppression<th>Edition</th>
         </tr>
         <c:forEach items="${model.categories}" var="cat">
           <tr>   
              ...
              <td><a onclick="return confirm('Etes-vous s�r ?')" href="supprimerCat?id=${cat.idCat }">Supprimer</a></td>
